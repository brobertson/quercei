...
def index
 @tagset = ["PRED", "SBJ", "OBJ", "ATR", "ADV", "ATV/AtvV", "PNOM", "OCOMP", "COORD", "APOS", "AuxP", "AuxC", "AuxR", "AuxV", "AuxX", "AuxG", "AuxK", "AuxV", "AuxZ", "ExD", "PRED_CO", "SBJ_CO", "OBJ_CO", "ATR_CO", "ADV_CO", "ATV/AtvV_CO", "PNOM_CO", "OCOMP_CO", "ADV_AP", "ATR_AP", "COORD_AP", "OBJ_AP"] 
